...
- 私人問題回報
- 管理員回覆及處理狀態
- 貓頭鷹通知：作者刊出、章節更新、許願回覆、授權往來、共創加入、月末讀報回顧（站內信，不再自動彈窗）
- 常見問題

### 留影走廊

- 純圖像投稿與畫廊瀏覽，全員可見並常駐導覽列
- 畫作搜尋（標題、繪師、角色）、角色篩選（任一／同框）與畫作收藏夾
- 全螢幕檢視：金色徽記浮水印、橫幅圖旋轉填滿、關閉按鈕
- 詳情卡：收藏、下載、授權請求與系列導覽
- 畫作署名（支援合創雙署名）、換圖與畫作系列共創
- 畫作授權：作者求畫、畫師主動授權，獲授權畫作可掛成文首圖
- 審核可「通過但不上留影走廊」（畫面沒有站內角色的文首圖）
- 個人隱藏畫作（牆上與心動封面一起隱藏、跨裝置同步）
- 已排時段的畫作併入「心動」封面池，依時段輪換

### 作家與編輯部

- 直接貼上內文或匯入 `.txt`
- 文首圖上傳與敘述欄：隨文章一起以畫作身份審核，通過後掛上留影走廊
- 本機自動保存未送出草稿
- 自訂發佈日期及未來排程
- 作品分類、角色及系列設定
- 作品管理種類分頁與搜尋（小說、畫作）
