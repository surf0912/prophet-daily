...
from routers import auth, novels, chapters, permissions, invites, feedback, custom_characters, app_settings
...
app.include_router(app_settings.router, prefix="/settings", tags=["settings"])  # global key→value (super_admin writes)
