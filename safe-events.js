...
(function () {
  ...
  const ALLOWED_ACTIONS = new Set([
    ...
    'cpCoverHint', 'discardUploadDraft', 'dismissInstallHint', 'dismissNotice', 'dismissContinueBar', 'dismissEditorLetter', 'dismissTourBanner', 'doInviteRegister', 'doLogout', 'downloadPhoto',
