...
(function () {
  ...
  const ALLOWED_ACTIONS = new Set([
    ...
    'onImagePick', 'submitImageWork', 'pickFrame', 'pickEditFrame', 'pickImageFile', 'pickReplaceImage', 'onReplaceImagePick', 'toggleForumMode',
    ...
    'setReviewMode', 'openReviewImage', 'toggleReviewWall', 'setOffWall', 'galleryAuthAsk', 'sendAuthRequest', 'openAuthDecide', 'saveAuthDecide', 'runDbLatency', 'pickActivityDay',
    'withdrawAuth', 'revokeAuth', 'readerOfferClick', 'adminResetAuth', 'applyAuthArt', 'moveHeaderArt', 'removeHeaderArt', 'galleryOpenWork', 'readerAuthClick', 'owlOpenAuth', 'attachDeriveArt', 'renderAuthMailbox',
