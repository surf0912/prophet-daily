...
(function () {
  ...
  const ALLOWED_ACTIONS = new Set([
    ...
    'withdrawAuth', 'revokeAuth', 'readerOfferClick', 'adminResetAuth', 'applyAuthArt', 'moveHeaderArt', 'removeHeaderArt', 'galleryOpenWork', 'readerAuthClick', 'owlOpenAuth', 'attachDeriveArt',
